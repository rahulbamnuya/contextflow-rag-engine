...
RUST_BASE_URL = os.getenv("RUST_BASE_URL", "http://127.0.0.1:8000/auth")
...
def document_upload_rag(file, description: str, jwt_token: str = None) -> bool:
    """
    ...
    Args:
        ...
        jwt_token: JWT/session token for authorization.
